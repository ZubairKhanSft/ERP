...
namespace AccountErp.Api.Controllers
{
    ...
    [ApiController]
    public class CurrencyCrController : ControllerBase
    {
        private readonly ICurrencyCrManager _manager;
        public CurrencyCrController(ICurrencyCrManager manager)
        {
            _manager = manager;
        }
        ...
        [HttpPost]
        [Route("add")]
        public async Task<IActionResult> Add([FromBody] AddCurrencyCrModel model)
        {
        ...
        [HttpPost]
        [Route("edit")]
        public async Task<IActionResult> Edit([FromBody] AddCurrencyCrModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorList());
